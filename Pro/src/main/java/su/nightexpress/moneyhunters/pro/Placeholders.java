...
public class Placeholders extends su.nexmedia.engine.utils.Placeholders {
    ...
    public static final String USER_JOBS_AMOUNT_PRIMARY   = "%user_jobs_amount_primary%";
    public static final String USER_JOBS_AMOUNT_SECONDARY = "%user_jobs_amount_secondary%";
