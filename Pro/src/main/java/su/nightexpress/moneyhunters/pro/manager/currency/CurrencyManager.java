package su.nightexpress.moneyhunters.pro.manager.currency;
...
import su.nightexpress.moneyhunters.pro.manager.currency.object.GamePointsCurrency;
import su.nightexpress.moneyhunters.pro.manager.currency.object.VaultCurrency;
...
public class CurrencyManager extends AbstractManager<MoneyHunters> {
    ...
    private void setupDefaults() {
        ...
        if (Hooks.hasPlugin(HookId.GAME_POINTS)) {
            this.registerCurrency(new GamePointsCurrency(this.plugin));
        }
    }
